...
/*describe('Renmoney APP Suite',function()
{
    ...
    it('Company',function()
    { 
        cy.get('.elementor-element-f25940d > .elementor-widget-container > .elementor-icon-list-items > :nth-child(2) > a > .elementor-icon-list-text').should('be.visible').contains('Car').click()  //Careers
        cy.url().should('include','careers')   //verify url
        cy.title().should('eq','Careers')  //verify page title.
        ...
        cy.get('.elementor-widget-container > .elementor-icon-list-items > :nth-child(1) > a > .elementor-icon-list-text').should('be.visible').contains('About').click({force:true})   //About Us. the element was not found. had to remve the parents "//.elementor-element-f25940d >" for it to work
        cy.url().should('include','about')   //verify url
        cy.title().should('eq','About Renmoney')  //verify page title.
        ...
        cy.get('.elementor-widget-container > .elementor-icon-list-items > :nth-child(3) > a > .elementor-icon-list-text').should('be.visible').contains('Contact').click({force:true})  //Contact. the parent was covered by css element. had to remve the parents "//.elementor-element-f25940d >" for it to work
        cy.url().should('include','contact')   //verify url
        //cy.title().should('eq','We're here to help')  //verify page title.   //not verifiable because of the apostrophy contained in "We're..." -it causes error.
    ...
    it('Contact',function()
    {
        cy.get('.elementor-element-95cfb96 > .elementor-widget-container > .premium-bullet-list-box > .elementor-repeater-item-a136908 > .premium-bullet-list-link').should('be.visible')  //23, Awolowo Road... 
        cy.get('.elementor-element-95cfb96 > .elementor-widget-container > .premium-bullet-list-box > .elementor-repeater-item-2cb0451 > .premium-bullet-list-link').should('be.visible')   //Email
        cy.get('.elementor-element-95cfb96 > .elementor-widget-container > .premium-bullet-list-box > .elementor-repeater-item-960bed8 > .premium-bullet-list-link').should('be.visible')  //Phone Call

        //Whistle Blower
        cy.get('.elementor-element-95cfb96 > .elementor-widget-container > .premium-bullet-list-box > .elementor-repeater-item-bbe5ed1 > .premium-bullet-list-link').should('be.visible').click()   //whistle Blower
        cy.url().should('include','whistleblowing')   //verify url  
        cy.title().should('eq','Whistle Blower')  //verify page title.
       ...
       // cy.get('#wpcf7-f13833-p12592-o2 > .wpcf7-form > .renmoney-form > :nth-child(9) > .wpcf7-form-control').should('be.visible').click()  //submit. dimmed because i dont want to disturb the company by submitting a complain.
        //cy.url().should('include','whistleblowing')   //verify url  
        //cy.title().should('eq','Whistle Blower')  //verify page title.
     ...
     it('Social',function()
    {
        cy.get('.elementor-element-8803313 > .elementor-widget-container > .elementor-social-icons-wrapper > :nth-child(1) > .elementor-icon > .e-font-icon-svg > use').should('be.visible').click({force:true})   //facebook
        cy.get('.elementor-element-8803313 > .elementor-widget-container > .elementor-social-icons-wrapper > :nth-child(2) > .elementor-icon > .e-font-icon-svg > use').should('be.visible').click({force:true})  //Linkedin
        cy.get('.elementor-element-8803313 > .elementor-widget-container > .elementor-social-icons-wrapper > :nth-child(3) > .elementor-icon > .e-font-icon-svg > use').should('be.visible').click()     //Twitter
        cy.get('.elementor-element-8803313 > .elementor-widget-container > .elementor-social-icons-wrapper > :nth-child(4) > .elementor-icon > .e-font-icon-svg > use').should('be.visible').click({force:true})    //Instagram
        cy.get('.elementor-element-8803313 > .elementor-widget-container > .elementor-social-icons-wrapper > :nth-child(5) > .elementor-icon > .e-font-icon-svg > use').should('be.visible').click({force:true})  //Medium
    })
})*/