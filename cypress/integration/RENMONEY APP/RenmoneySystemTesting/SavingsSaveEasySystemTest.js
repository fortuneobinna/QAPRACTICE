describe('Renmoney Savings Process- System Testing',function()
{
    ...
    it('Savings Process: Easy Saving Package',function()
    {
        ...
        cy.get(':nth-child(3) > .button-5').should('be.visible').contains('Get Started').click()     //Easy Savings
...
//Initial Process. First application to save. it worked. subsequently, the above codes will be used to test this function'
/*describe('Renmoney APP Suite',function()
{
    ...
    it('Savings Process: Easy Saving Package',function()
    {
        ...
        cy.get('.elementor-element-378b9d0 > .elementor-widget-container > .elementor-button-wrapper > .elementor-button-link > .elementor-button-content-wrapper > .elementor-button-text').click()  //Easy Savings
        cy.title().should('eq','Renmoney')
